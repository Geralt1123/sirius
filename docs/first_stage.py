...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(1040, 310, 471, 80))
        self.groupBox_4.setObjectName("groupBox_4")
        self.label_17 = QtWidgets.QLabel(parent=self.groupBox_4)
        self.label_17.setGeometry(QtCore.QRect(10, 20, 101, 16))
        self.label_17.setObjectName("label_17")
        self.bilat_d = QtWidgets.QTextEdit(parent=self.groupBox_4)
        self.bilat_d.setGeometry(QtCore.QRect(40, 40, 31, 31))
        self.bilat_d.setObjectName("bilat_d")
        self.add_bilat = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.add_bilat.setGeometry(QtCore.QRect(310, 20, 151, 51))
        self.add_bilat.setObjectName("add_bilat")
        self.label_18 = QtWidgets.QLabel(parent=self.groupBox_4)
        self.label_18.setGeometry(QtCore.QRect(120, 20, 71, 16))
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(parent=self.groupBox_4)
        self.label_19.setGeometry(QtCore.QRect(200, 20, 101, 16))
        self.label_19.setObjectName("label_19")
        self.bilat_color = QtWidgets.QTextEdit(parent=self.groupBox_4)
        self.bilat_color.setGeometry(QtCore.QRect(140, 40, 31, 31))
        self.bilat_color.setObjectName("bilat_color")
        self.bilat_coord = QtWidgets.QTextEdit(parent=self.groupBox_4)
        self.bilat_coord.setGeometry(QtCore.QRect(230, 40, 31, 31))
        self.bilat_coord.setObjectName("bilat_coord")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_4.setTitle(_translate("MainWindow", "Двусторонний фильтр"))
        self.label_17.setText(_translate("MainWindow", "Диаметр пикселя"))
        self.add_bilat.setText(_translate("MainWindow", "Применить"))
        self.label_18.setText(_translate("MainWindow", "Сигма цвета"))
        self.label_19.setText(_translate("MainWindow", "Сигма координат"))
